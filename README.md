...
```
cd existing_repo
git remote add origin https://gitlab.com/sitisalwa/self-nextjs-project.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/sitisalwa/self-nextjs-project/-/settings/integrations)
...
>>>>>>> fbeaa2e9ba0a184be0aadb12c6dc85e4ddf6b49a
