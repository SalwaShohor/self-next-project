...
import AntVG6Navigation from "@/components/antv-g6/behavior/AntVG6Navigation";
import TestingSigma from "@/components/sigma/edge-curve/basic-example/TestingSigma";
import SigmaNavigation from "@/components/sigma/behavior/SigmaNavigation";
import BasicExample from "@/components/sigma/behavior/BasicExample";
import { NavigationTable } from "@/components/Tables/features-table/NavigationTable";
...
export default function Page() {
  ...
  return (
    <>
      <Breadcrumb pageName="Behavior: Navigation" />
